...
export default function ISAPriv() {
  const filteredData = RatifiedData.filter((d) => d.community === "Privileged Horizontal Committee")
  return (
    <Layout>
      <h1>Isa Privilaged Details View</h1>
      <DetailsTable data={data} columns={columns} />
      <h2>ISA Ratified Specifications</h2>
      <p>This section contains the specifications which were independently ratified and subsequently have been pulled into the appropriate ISA volumes published on the RISC-V Technical Specifications page.</p>
