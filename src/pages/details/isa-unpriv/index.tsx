  ...
  return (
    <Layout>
      <main className="details-main">
        ...
        <p>
          The RISC-V ISA Unprivileged Specification is a collection of all of
          the ratified, published unprivileged extensions for RISC-V.
        </p>
        ...
        <p>
          ...
          Unprivileged Specification document.
        </p>

        <h2>ISA Ratified Specifications Archive</h2>
        <p>
          Find the list of all archived ratified technical specification
          versions for the Unprivileged Specification.
        </p>
