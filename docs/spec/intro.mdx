...
<RvCardGrid>
  <RvCard details='/details/isa-priv' pdfLink='www.google.com' title='ISA Volume I - Unpriv' buttonLabel='View Spec' buttonHref={`${siteConfig.baseUrl}isa`}>
    <RvCardVersioning>
  ...
  <RvCard details='/details/isa-unpriv' title='ISA Volume II - Priv' buttonLabel='Version: May 2024' buttonHref={`${siteConfig.baseUrl}isa`}>
    <ul>
