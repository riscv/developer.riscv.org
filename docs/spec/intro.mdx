...
<RvCardGrid>
  <RvCard details={`${siteConfig.baseUrl}/details/isa-priv`} pdfLink='www.google.com' title='ISA Volume I - Unpriv' buttonLabel='View Spec' buttonHref={`${siteConfig.baseUrl}isa`}>
    <RvCardVersioning>
